...
public class BetterGrassAndLeavesMod implements ClientModInitializer {
    ...
    public static OptionOffOn renderBetterGrass = new OptionOffOn(modOptions, "renderBetterGrass", "更好的草", "是否开启更好的草？", "Off");
    public static OptionChoice currentGrassRenderer = new OptionChoice(modOptions, "currentGrassRenderer", "草的渲染", "选择草的渲染效果", "无", new String[]{"标准", "无"});
    public static OptionOffFastFancy renderGrassSides = new OptionOffFastFancy(modOptions, "renderGrassSides", "草方块四周", "草方块四周是否有植物？", "关闭");
    public static OptionOffOn renderSnowedGrass = new OptionOffOn(modOptions, "renderSnowedGrass", "雪地的草", "被雪覆盖的草的效果", "Off");
    public static OptionOffFastFancy renderGrassFX = new OptionOffFastFancy(modOptions, "renderGrassFX", "触碰草的特效", "选择触碰草时的特效", "Off");
    ...
    public static OptionOffOn renderBetterLeaves = new OptionOffOn(modOptions, "renderBetterLeaves", "更好的树叶", "是否开启更好的树叶？", "Off");
    public static OptionChoice currentLeavesRenderer = new OptionChoice(modOptions, "currentLeavesRenderer", "树叶的渲染", "选择树叶的渲染效果", "无", new String[]{"标准", "高级", "无"});
    public static OptionOffOn renderSnowedLeaves = new OptionOffOn(modOptions, "renderSnowedLeaves", "覆盖雪的树叶", "被雪覆盖的树叶的效果", "Off");
    ...
    public static OptionOffOn useRoundedVanillaLeaves = new OptionOffOn(modOptions, "useRoundedVanillaLeaves", "圆形树叶贴图", "使用圆形树叶贴图替换原始方形树叶贴图", "Off");
